    ...
    return Padding(
      ...
      child: async.when(
        data: (items) => SectionCard(
          ...
          child: items.isEmpty
              ? Padding(
                  ...
                  child: Text(emptyText, style: TextStyle(fontSize: 13, color: ZelloColors.textTertiary, fontStyle: FontStyle.italic)),
                )
              : Column(
        ...
        error: (e, _) => SectionCard(
          ...
          iconColor: iconColor,
          title: title,
          child: Text('Erro: $e', style: TextStyle(fontSize: 12, color: ZelloColors.danger)),
        ),
      ),
    );
  }
